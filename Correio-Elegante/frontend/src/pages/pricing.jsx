...
export default function Pricing({ goToHome }) {
  ...
  const plans = [
...

    {
      id: "p4",
      emoji: "💌🍭🍬",
      title: "Combo (Carta + Pirulito + Bombom)",
      price: "R$ 0,00",
    ...
    },
    {
      id: "p5",
      emoji: "🎶💌",
      title: "Serenata + Cartinha",
      price: "R$ 0,00",
      features: ["Serenata personalizada", "1 Carta"],
    },
    {
      id: "p6",
      emoji: "🎶🍭",
      title: "Serenata + Pirulito",
      price: "R$ 0,00",
      features: ["Serenata personalizada", "1 Pirulito"],
    },
    {
      id: "p7",
      emoji: "🎶🍬💌",
      title: "Serenata + Bombom + Cartinha",
      price: "R$ 0,00",
      features: ["Serenata personalizada", "1 Bombom", "1 Carta"],
    },
    {
      id: "p8",
      emoji: "🎶💝",
      title: "Serenata + Combo Completo",
      price: "R$ 0,00",
      features: ["Serenata personalizada", "1 Carta", "1 Pirulito", "1 Bombom"],
    },
    {
      id: "p9",
      emoji: "💐💌",
      title: "Buquê + Cartinha",
      price: "R$ 0,00",
      features: ["Buquê", "1 Carta"],
    },
  ];
